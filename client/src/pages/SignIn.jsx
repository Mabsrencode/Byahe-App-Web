    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                <div className="rounded-lg bg-white p-4 lg:p-8 shadow-lg md:w-1/2 mx-2 md:mx-auto mb-[10%] mt-[5%] lg:w-1/3">
                    ...
                    {error && <p className="text-red mt-2 bg-gray-100 py-1 rounded-xl mt-12 font-semibold px-4 inline-block">{error}</p>}
                </div>
            </form>
        </>
    );
